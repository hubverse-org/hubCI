# Contributing to hubCI

This outlines how to propose a change to `hubCI`. For more general info
about contributing to this, and other hubverse packages, please see the
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("hubverse-org/hubCI", fork = TRUE)`.
...
Please note that the hubCI project is released with a [Contributor Code
of Conduct](https://hubverse-org.github.io/hubCI/CODE_OF_CONDUCT.md). By
